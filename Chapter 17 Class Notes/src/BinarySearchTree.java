...
{   
    ...
    */
    public void remove(Comparable obj)
    {
        ...
        //case 3, node toBeRemoved has 2 children, find least element of the right subtree
    ...
    */
    static class Node
    {   
        public Comparable data;//has to be comparable
        public Node left;
        public Node right;
        ...
        */
        ...
        {   
            //if compareTo < 0 newnode is to the leftif compareTo is >0 newNode is to the right
